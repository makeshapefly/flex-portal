...
<Grid cols={12} gapX="space">
  <Col cols={{ span: 12 }} xl={{ span: 8 }} class="xl:col-start-3">
    <Card>
      <CardBody>
        ...
        <p class="mb-3 text-gray-500 dark:text-dark-500">
          [Your Company Name] ("we", "us", or "our") is committed to protecting the privacy and
          security of your personal information. This Privacy Policy outlines the types of
        ...
        <ul class="mb-3 space-y-2 list-inside list-circle">
          <li>
            <span class="font-semibold">Personal Information:</span> Such as your name, email address,
            phone number, and other contact information provided voluntarily when you interact with us
            through our website, applications, or other communication channels.
          </li>
          <li>
            <span class="font-semibold">Usage Data:</span> Information about how you interact with our
            services, including your IP address, browser type, operating system, and other technical
            information.
          </li>
          <li>
            <span class="font-semibold">Cookies and Similar Technologies:</span> We may use cookies,
            web beacons, and other tracking technologies to enhance your experience and gather information
        ...
        <ul class="mb-3 space-y-2 list-inside list-circle">
          ...
          <li>
            To analyze usage trends and improve the functionality of our website and applications.
          </li>
        ...
        <p class="mb-2 text-gray-500 dark:text-dark-500">
          ...
          type and settings, operating system, mobile network information including carrier name and
          phone number, and application version number. We also collect information about the
          interaction of your apps, browsers, and devices with our services, including IP address,
        ...
        <p class="mb-3 text-gray-500 dark:text-dark-500">
          ...
          your personal information and prevent unauthorized access, disclosure, alteration, or
          destruction.
        </p>
        <h6 class="mb-2">Your Choices</h6>
        <p class="mb-3 text-gray-500 dark:text-dark-500">
          You have the right to access, update, or delete your personal information at any time. You
          may also opt-out of receiving promotional communications from us by following the
        ...
        <div class="flex justify-end gap-2 mt-5">
          <a href="#!" class="btn btn-green">Accepted</a>
          <a href="#!" class="border-dashed btn btn-dashed-red">I Disagree</a>
        </div>
      </CardBody>
    </Card>
  </Col><!--end col-->
