export const emailData = [
  {
    ...
    avatarImage: '/assets/images/avatar/user-11.png',
    ...
    replies: [
      {
        id: 101,
        sender: 'Lena Meyer',
        email: 'lena@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-18.png',
  ...
  },
  {
    ...
    avatarImage: '/assets/images/avatar/user-13.png',
    ...
    replies: [
      {
        id: 102,
        sender: 'Ryan Carter',
        email: 'ryan@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-10.png',
        date: '14 May, 12:00PM',
    ...
    replies: [
      {
        id: 103,
        sender: 'Emily White',
        email: 'emily@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-15.png',
    ...
    replies: [
      {
        id: 104,
        sender: 'Lucas Meyer',
        email: 'lucas@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-17.png',
        date: '10 May, 11:30AM',
    ...
    replies: [
      {
        id: 105,
        sender: 'Anna Klein',
        email: 'anna@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-19.png',
    ...
    replies: [
      {
        ...
        email: 'michael@srbthemes.com',
        avatarImage: '/assets/images/avatar/user-16.png',
  ...
  },
  {
    id: 9,
    sender: 'Mike Johnson',
    email: 'mike@srbthemes.com',
    date: '07 July, 08:00AM',
    subject: 'Spam Alert',
    message: 'This is a spam email. Please ignore.',
    avatarImage: '/assets/images/avatar/user-14.png',
    badges: ['Spam'],
    type: 'spam',
    replies: []
  },
