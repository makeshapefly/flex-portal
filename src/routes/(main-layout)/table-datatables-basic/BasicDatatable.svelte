<script lang="ts">
	...
	import { employeesData } from './basic';
...
<div class="grid gap-5">
	...
	<div class="overflow-x-auto">
		<table class="display group table" style="width:100%">
			<thead>
				<tr class="dark:bg-dark-850 bg-gray-100 *:px-3 *:py-2.5">
					<th class="cursor-pointer" on:click={() => sortTable('Name')}>Name</th>
					<th class="cursor-pointer" on:click={() => sortTable('Position')}>Position</th>
					<th class="cursor-pointer" on:click={() => sortTable('Office')}>Office</th>
					<th class="cursor-pointer" on:click={() => sortTable('Age')}>Age</th>
					<th class="cursor-pointer" on:click={() => sortTable('Start date')}>Start date</th>
					<th class="cursor-pointer" on:click={() => sortTable('Salary')}>Salary</th>
				</tr>
			</thead>
			<tbody>
