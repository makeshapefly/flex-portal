...
<div class="grid gap-5">
	...
	<div class="overflow-x-auto">
		<table class="display group even-striped table" style="width:100%">
			<thead>
				<tr class="dark:bg-dark-850 bg-gray-100">
					<th
						class="dark:bg-dark-850 cursor-pointer bg-gray-100 ltr:text-left rtl:text-right"
						on:click={() => sortTable('Name')}>Name</th
					>
					<th
						class="dark:bg-dark-850 cursor-pointer bg-gray-100 ltr:text-left rtl:text-right"
