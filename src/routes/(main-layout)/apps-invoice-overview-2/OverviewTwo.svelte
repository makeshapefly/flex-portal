<script lang="ts">
	...
	import { invoicesData } from './app-invoice';
...
<div class="mx-auto mb-5 sm:max-w-6xl print:max-w-full" id="invoice-content">
	<div class="card relative overflow-hidden print:border-0 print:shadow-none">
		<div
			class="from-primary-500/10 absolute inset-x-0 top-0 bottom-0 bg-gradient-to-b blur-2xl print:hidden"
		></div>
		<div
			class="bg-primary-500 top-0 hidden h-40 w-96 md:absolute md:block ltr:right-0 ltr:rounded-bl-full rtl:left-0 rtl:rounded-br-full print:hidden"
		></div>
		<div class="card-body relative md:p-10 print:p-0">
			<div class="mb-8 md:flex">
				...
				<div class="mt-6 space-y-2 text-right md:mt-0">
					<p class="md:text-primary-100 dark:md:text-primary-100">
						Support Email: <a
							href="mailto:support@example.com"
							class="dark:text-dark-50 md:text-primary-50 dark:md:text-primary-50 font-semibold text-gray-900"
...
Fosses-la-Ville, Belgium - 4823</pre>
		...
		<div class="card-footer flex flex-wrap items-center border-sky-500/20 bg-sky-500/10">
	...
	<div
		class="print:mt-space flex flex-wrap items-center justify-end gap-2 print:hidden print:border-0"
	>
