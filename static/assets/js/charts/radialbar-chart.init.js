...
Author: Srbthemes
Version: 1.0.0
File: radialbar-chart init Js File
*/
...
document.addEventListener('alpine:init', () => {
  Alpine.data('basicRadialbarApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basicRadialbarChart) this.basicRadialbarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multipleRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.multipleRadialbarChart) this.multipleRadialbarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('customAngleRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.customAngleRadialbarChart) this.customAngleRadialbarChart.destroy();

      // Initialize new chart
      this.customAngleRadialbarChart = new ApexCharts(
        this.$refs.customAngleRadialbarChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('gradientRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.gradientRadialbarChart) this.gradientRadialbarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('imageRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.imageRadialbarChart) this.imageRadialbarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('strokedGaugeRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.strokedGaugeRadialbarChart) this.strokedGaugeRadialbarChart.destroy();

      // Initialize new chart
      this.strokedGaugeRadialbarChart = new ApexCharts(
        this.$refs.strokedGaugeRadialbarChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('semiGaugeRadialbarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.semiGaugeRadialbarChart) this.semiGaugeRadialbarChart.destroy();

      // Initialize new chart
      this.semiGaugeRadialbarChart = new ApexCharts(
        this.$refs.semiGaugeRadialbarChart,
        this.options
      );
