...
document.addEventListener('alpine:init', () => {
  Alpine.data('basicBarApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basicBarChart) this.basicBarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('stackedBar100App', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.stackedBar100Chart) this.stackedBar100Chart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('groupedStackedBarApp', () => ({
    ...
    labels: ['Online advertising', 'Sales Training', 'Print advertising', 'Catalogs', 'Meetings'],
    init() {
      // Initial chart render
      this.renderChart();
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.groupedStackedBarChart) this.groupedStackedBarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('negativeValueBarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.negativeValueBarChart) this.negativeValueBarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('markersBarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.markersBarChart) this.markersBarChart.destroy();
      // Initialize new chart
...
document.addEventListener('alpine:init', () => {
  Alpine.data('reversedBarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.reversedBarChart) this.reversedBarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('patternedBarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.patternedBarChart) this.patternedBarChart.destroy();
