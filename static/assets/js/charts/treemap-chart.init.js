...
Author: Srbthemes
Version: 1.0.0
File: treemap-chart init Js File
*/
...
document.addEventListener('alpine:init', () => {
  Alpine.data('basiTreepmapApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basiTreepmapChart) this.basiTreepmapChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multipleTreemapApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.multipleTreemapChart) this.multipleTreemapChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('colorRangeTreemapApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.colorRangeTreemapChart) this.colorRangeTreemapChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('distributedTreemapApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.distributedTreemapChart) this.distributedTreemapChart.destroy();

      // Initialize new chart
      this.distributedTreemapChart = new ApexCharts(
        this.$refs.distributedTreemapChart,
        this.options
      );
