...
document.addEventListener('alpine:init', () => {
  Alpine.data('simplePieApp', () => ({
    ...
    renderChart() {
      ...
      if (this.simplePieChart) this.simplePieChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('monochromePieApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.monochromePieChart) this.monochromePieChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('semiDonutApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.semiDonutChart) this.semiDonutChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('patternDonutApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.patternDonutChart) this.patternDonutChart.destroy();
