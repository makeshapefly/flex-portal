...
document.addEventListener('alpine:init', () => {
  Alpine.data('basicLineApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basicLineChart) this.basicLineChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('zoomableLineApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.zoomableLineChart) this.zoomableLineChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('steplineLineApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.steplineLineChart) this.steplineLineChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('gradientLineApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.gradientLineChart) this.gradientLineChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('dashedLineApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.dashedLineChart) this.dashedLineChart.destroy();
