...
document.addEventListener('alpine:init', () => {
  Alpine.data('basicRadarApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basicRadarChart) this.basicRadarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multipleRadarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.multipleRadarChart) this.multipleRadarChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('polygonRadarApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.polygonRadarChart) this.polygonRadarChart.destroy();
