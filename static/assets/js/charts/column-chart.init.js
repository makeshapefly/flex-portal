...
Author: Srbthemes
Version: 1.0.0
File: column-chart init Js File
*/
...
document.addEventListener('alpine:init', () => {
  Alpine.data('stackedColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.stackedColumnChart) this.stackedColumnChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('stackedColumn100App', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.stackedColumn100Chart) this.stackedColumn100Chart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('groupStackedColumnApp', () => ({
    ...
    renderChart() {
      ...
      // Initialize new chart
      this.groupStackedColumnChart = new ApexCharts(
        this.$refs.groupStackedColumnChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('dumbbellColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.dumbbellColumnChart) this.dumbbellColumnChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('markersColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.markersColumnChart) this.markersColumnChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('groupLabelColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.groupLabelColumnChart) this.groupLabelColumnChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('rotatedLabelColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.rotatedLabelColumnChart) this.rotatedLabelColumnChart.destroy();

      // Initialize new chart
      this.rotatedLabelColumnChart = new ApexCharts(
        this.$refs.rotatedLabelColumnChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('negativeLabelColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.negativeLabelColumnChart) this.negativeLabelColumnChart.destroy();

      // Initialize new chart
      this.negativeLabelColumnChart = new ApexCharts(
        this.$refs.negativeLabelColumnChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('distributedColumnApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.distributedColumnChart) this.distributedColumnChart.destroy();
