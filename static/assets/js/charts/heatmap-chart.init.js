...
Author: Srbthemes
Version: 1.0.0
File: heatmap-chart init Js File
*/
...
document.addEventListener('alpine:init', () => {
  Alpine.data('basicHatmapApp', () => ({
    ...
    renderChart() {
      ...
      if (this.basicHatmapChart) this.basicHatmapChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multiColorHatmapApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.multiColorHatmapChart) this.multiColorHatmapChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multiColorFlippedHatmapApp', () => ({
    ...
    renderChart() {
      ...
      // Initialize new chart
      this.multiColorFlippedHatmapChart = new ApexCharts(
        this.$refs.multiColorFlippedHatmapChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('roundedHatmapApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.roundedHatmapChart) this.roundedHatmapChart.destroy();
