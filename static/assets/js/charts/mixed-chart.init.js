...
document.addEventListener('alpine:init', () => {
  Alpine.data('lineColumnApp', () => ({
    ...
    renderChart() {
      ...
      if (this.lineColumnChart) this.lineColumnChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('lineAreaApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.lineAreaChart) this.lineAreaChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('lineColumnAreaApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.lineColumnAreaChart) this.lineColumnAreaChart.destroy();
...
document.addEventListener('alpine:init', () => {
  Alpine.data('lineScatterApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.lineScatterChart) this.lineScatterChart.destroy();
      // Initialize new chart
