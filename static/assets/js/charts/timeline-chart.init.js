...
Author: Srbthemes
Version: 1.0.0
File: timeline-chart init Js File
*/
...
document.addEventListener('alpine:init', () => {
  Alpine.data('multipleGroupTimelineApp', () => ({
    ...
    renderChart() {
      ...
      // Initialize new chart
      this.multipleGroupTimelineChart = new ApexCharts(
        this.$refs.multipleGroupTimelineChart,
        this.options
      );
...
document.addEventListener('alpine:init', () => {
  Alpine.data('dumbbellTimelineApp', () => ({
    ...
    renderChart() {
      // Destroy previous instance if exists
      if (this.dumbbellTimelineChart) this.dumbbellTimelineChart.destroy();
